...
public class DashboardFragment extends Fragment {
    ...
    ArrayList<User> monthRegisterlist = new ArrayList<>() ;
    ArrayList<User> expWeeklist = new ArrayList<>() ;
    ArrayList<User> expMonthlist = new ArrayList<>() ;
    ArrayList<User> fullPayList = new ArrayList<>() ;
    ArrayList<User> halfPayList = new ArrayList<>() ;
...
//                    intent.putExtra("ModalList", DeleteList);
...
//                    Intent intent = new Intent(getContext(), MembersActivity.class);
//                    intent.putExtra("ModalList", fullPayList);
...
//                    Intent intent = new Intent(getContext(), MembersActivity.class);
//                    intent.putExtra("ModalList", allList);
//                    intent.putExtra("type" , "") ;
//                    startActivity(intent);
                }
